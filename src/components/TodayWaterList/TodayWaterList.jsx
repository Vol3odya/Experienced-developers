...
export default function TodayWaterList() {
  ...
  // const handleOpenModalEdit = (event) => {
  //   const _id = event.target.parentNode.parentNode.parentNode.id;
  //   const time = event.target.parentNode.parentNode.parentNode.time;
  //   setIsModalOpen({ _id, time });
  // };
                  ...
                  />*/}
                    ...
                    >
                      <path
                        ...
                        stroke="#8BAEFF" /*stroke-linecap="round" stroke-linejoin="round"*/
                      />
                    </svg>
                  </button>
                  <button
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        stroke="#EF5050" /*stroke-linecap="round" stroke-linejoin="round"*/
                      />
                    </svg>
                  </button>
                </div>
